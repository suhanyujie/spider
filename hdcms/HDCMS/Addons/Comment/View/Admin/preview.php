    ...
    <list from="$data" name="$d">
        <div class="comment-list" id="c-{$d.comment_id}">
            ...
            <div class="comment-body">
                <div class="comment-author c-user-name">
                            ...
                            <div class="reply-body" id="r-{$r.reply_id}">
                                ...
                                <div class="reply-box">
                                    <div class="reply-author">
                                        <div class="user">
                                            <a href="javascript:;" class="c-user-name">{$r.username}</a> • 1 分钟前
                                        </div>
                                        <div class="reply-del">
                                            <?php if(isset($_SESSION['user'])){?>
                                                <?php if($_SESSION['user']['uid']==$r['user_id']){?>
                                                    <a href="javascript:;" onclick="delReply({$r.comment_id},{$r.reply_id},'{|U:'Reply/delReply'}')">删除</a>
                                                <?php }?>
                                                <?php if($_SESSION['user']['uid']!=$r['user_id']){?>
