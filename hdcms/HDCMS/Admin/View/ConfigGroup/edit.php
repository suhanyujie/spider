...
<div class="hd-menu-list">
    <ul>
        <li><a href="{|U:'index'}">配置组列表</a></li>
        <li class="active"><a href="__URL__">修改配置组</a></li>
    </ul>
</div>
...
<form class="hd-form" onsubmit="return hd_submit(this,'__ACTION__','{|U:'index'}')">
    ...
    <table class="hd-table hd-table-form">
        <tr>
            ...
            <td>
                <input type="text" name="cgname" class="hd-w200" value="{$field.cgname}"/>
            </td>
        </tr>
        <tr>
            <th>组标题</th>
            <td>
                <input type="text" name="cgtitle" class="hd-w200" value="{$field.cgtitle}"/>
            </td>
        </tr>
        <tr>
            <th>排序</th>
            <td>
                <input type="text" name="cgorder" class="hd-w200" value="100" value="{$field.cgorder}"/>
            </td>
        </tr>
    </table>
